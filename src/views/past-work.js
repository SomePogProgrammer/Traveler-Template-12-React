...
const PastWork = (props) => {
  return (
    <div className="past-work-container">
      ...
      <div className="past-work-container1">
        <React.Fragment>
          <Script>{`
  /* PrismJS 1.29.0
...
`}</Script>
          ...
          >
            ...
            >
              ...
              {'}'}){'\n'}
              {'\n'}
              {'  '}const databaseURL = "localhost:8030/notAn_Actual_Index" //
              No this isn't stored locally just an example{'\n'}
      ...
      <div className="past-work-testimonial">
        <div className="past-work-container2">
          ...
          <div className="past-work-container3">
            <TestimonialCard1 rootClassName="rootClassName2"></TestimonialCard1>
        ...
        <div className="past-work-container4">
          <div className="past-work-container5">
            <div className="past-work-container6">
              <TestimonialCard3 rootClassName="rootClassName1"></TestimonialCard3>
            </div>
            <TestimonialCard3 rootClassName="rootClassName2"></TestimonialCard3>
          </div>
